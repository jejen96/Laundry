...
<div class="box box-info">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                    ...
                    <input type="hidden" class="form-control" id="id" placeholder="id" value="${outlet.id}">
                
                 <div class="form-group">
                  <label class="col-sm-2 control-label">Nama Outlet</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nameOutlet" placeholder="Nama Outlet" value="${outlet.nameOutlet}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="addressOutlet" placeholder="Alamat Lengkap Outlet" value="${outlet.addressOutlet}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="phoneNumberOutlet" placeholder="Kontak Outlet" value="${outlet.phoneNumberOutlet}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="lat" placeholder="Titik Kordinat Latitude" value="${outlet.lat}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="lng" placeholder="Titik Kordinat Longitude" value="${outlet.lng}">
                  </div>
                </div>
