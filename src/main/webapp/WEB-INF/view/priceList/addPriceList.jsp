...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Input Data<small>Price List</small>
		</h1>
		<ol class="breadcrumb">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="namePriceList" placeholder="Nama Jasa Laundry">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="priceList" placeholder="Rp. Harga Jasa Laundry">
                  </div>
                </div>
